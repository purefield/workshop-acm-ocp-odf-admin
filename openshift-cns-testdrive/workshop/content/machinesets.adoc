...
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2a   1         1         1       1           47h
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2b   1         1         1       1           47h
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2c   1         1         1       1           47h
----
...
{{ CLUSTER_NAME }}-ab12-lpxbs-master-0                  i-04280885cafad3130   running   m4.xlarge    us-east-2   us-east-2a   47h
{{ CLUSTER_NAME }}-ab12-lpxbs-master-1                  i-0def910edcae51d11   running   m4.xlarge    us-east-2   us-east-2b   47h
{{ CLUSTER_NAME }}-ab12-lpxbs-master-2                  i-0beb5e40214d706fc   running   m4.xlarge    us-east-2   us-east-2c   47h
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2a-b94pr   i-0a922c0fe765caa3c   running   m5.2xlarge   us-east-2   us-east-2a   47h
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2b-m8gbx   i-0fb8d960b8a3a3343   running   m5.2xlarge   us-east-2   us-east-2b   47h
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2c-5tmg7   i-0151c72cd85f85038   running   m5.2xlarge   us-east-2   us-east-2c   47h
----
...
----
oc scale machineset {{ CLUSTER_NAME }}-ab12-hx2ml-worker-us-east-2c -n openshift-machine-api --replicas=2
----
...
----
{{ CLUSTER_NAME }}-ab12-lpxbs-worker-us-east-2c-h7gdt   i-0b9208ec47f0e206b   running   m5.2xlarge     us-east-2   us-east-2c   47s
----
...
[source,bash,role="copypaste copypaste-warning"]
----
oc scale machineset {{ CLUSTER_NAME }}-ab12-hx2ml-worker-us-east-2c -n openshift-machine-api --replicas=1
----
